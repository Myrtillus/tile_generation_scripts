...
/home/nissiant/Garmin_OSM_TK_map/osmosis/bin/osmosis --rx /var/tmp/osm/tampere.osm --rx /var/tmp/osm/oulu.osm --rx /var/tmp/osm/porvoo.osm --merge --merge --wx /var/tmp/osm/merged.osm
